...
class _RoundTwoCh2State extends State<RoundTwoCh2> {
  ...
  String enemyImage =
      'assets/images/module4/chapter2/round2/skeleton1_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module4/chapter2/round2/skeleton1_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module4/chapter2/round2/skeleton1_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module4/chapter2/round2/skeleton1_attack.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('sword.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module4/chapter2/round2/skeleton1_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module4/chapter2/round2/skeleton1_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module4/chapter2/round2/skeleton1_idle.gif';
  ...
  void _navigateToModuleOne() {
    ...
    ModuleFourProgress.updateStarsForChapter(2, currentRound, stars);
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/GameSceneBG/GameSceneBG4.png'),
                fit: BoxFit.fill,
              ),
            ),
          ),
