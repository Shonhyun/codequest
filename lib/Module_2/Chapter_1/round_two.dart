...
class _RoundTwoState extends State<RoundTwo> {
  ...
  String enemyImage = 'assets/images/module2/chapter1/round2/orc1_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module2/chapter1/round2/orc1_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module2/chapter1/round2/orc1_idle.gif';
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module2/chapter1/round2/orc1_run.gif';
      enemyPosition = screenWidth * attackEnemyPosition;
    });

    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage = 'assets/images/module2/chapter1/round2/orc1_attck1.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module2/chapter1/round2/orc1_walk_RL.gif';
  ...
  void _handleHeroDeath() {
    ...
    Future.delayed(Duration(milliseconds: 900), () {
      setState(() {
        isHeroDead = true;
        enemyImage = 'assets/images/module2/chapter1/round2/orc1_walk_RL.gif';
      });

      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage = 'assets/images/module2/chapter1/round2/orc1_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module2/chapter1/round2/orc1_dead.gif';
    });
  ...
  void _navigateToModuleTwo() {
    ...
    ModuleTwoProgress.updateStarsForChapter(1, currentRound, stars);
