...
class _RoundThreeState extends State<RoundThree> {
  ...
  String enemyImage = 'assets/images/module2/chapter1/round3/Kitsune_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module2/chapter1/round3/Kitsune_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module2/chapter1/round3/Kitsune_idle.gif';
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module2/chapter1/round3/Kitsune_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module2/chapter1/round3/Kitsune_attack1.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('splash.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module2/chapter1/round3/Kitsune_walk_RL.gif';
  ...
  void _handleHeroDeath() {
    ...
    Future.delayed(Duration(milliseconds: 900), () {
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage = 'assets/images/module2/chapter1/round3/Kitsune_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module2/chapter1/round3/Kitsune_dead.gif';
    });
  ...
  void _navigateToModuleTwo() {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ModuleTwoMap(completedRoundChapter1: currentRound),
      ),
    );
  }
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: countdown <= 10
                          ? Colors.red
                          : Colors
                              .white, // Change to red if countdown is 10 or less // Fill color
                      shadows: [
                        Shadow(
                          blurRadius: 10.0,
                          color: Colors.black,
