...
class _RoundThreeCh3State extends State<RoundThreeCh3> {
  ...
  String enemyImage = 'assets/images/module5/chapter3/round3/fire_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module5/chapter3/round3/fire_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module5/chapter3/round3/fire_idle.gif';
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter3/round3/fire_run.gif';
      enemyPosition = screenWidth * attackEnemyPosition;
    });

    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage = 'assets/images/module5/chapter3/round3/fire_attack2.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('fire.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module5/chapter3/round3/fire_walk_RL.gif';
  ...
  void _handleHeroDeath() {
    ...
    Future.delayed(Duration(milliseconds: 900), () {
      setState(() {
        isHeroDead = true;
        enemyImage = 'assets/images/module5/chapter3/round3/fire_walk_RL.gif';
      });

      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage = 'assets/images/module5/chapter3/round3/fire_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter3/round3/fire_dead.gif';
    });
  ...
  void _navigateToModuleFive() {
    ...
    int currentRound = 3;
    ModuleFiveProgress.updateStarsForChapter(3, currentRound, stars);
