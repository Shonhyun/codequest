...
class _RoundOneCh3State extends State<RoundOneCh3> {
  ...
  String enemyImage = 'assets/images/module1/chapter3/round1/warrior3_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter3/round1/warrior3_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter3/round1/warrior3_attck2.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter3/round1/warrior3_walk_RL.gif';
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              enemyImage =
                  'assets/images/module1/chapter3/round1/warrior3_idle.gif';
              heroImage = 'assets/images/hero.gif';
            });
          });
        }
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter3/round1/warrior3_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter3/round1/warrior3_idle.gif';
