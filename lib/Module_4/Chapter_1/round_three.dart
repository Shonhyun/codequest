...
class _RoundThreeState extends State<RoundThree> {
  ...
  String enemyImage =
      'assets/images/module4/chapter1/round3/whitewolf_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module4/chapter1/round3/whitewolf_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module4/chapter1/round3/whitewolf_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module4/chapter1/round3/whitewolf_attack1.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module4/chapter1/round3/whitewolf_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module4/chapter1/round3/whitewolf_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module4/chapter1/round3/whitewolf_idle.gif';
  ...
  void _navigateToModuleOne() {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ModuleFourMap(completedRoundChapter1: currentRound),
      ),
    );
  }
