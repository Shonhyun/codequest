...
class _GameScreenState extends State<GameScreen> {
  ...
  String enemyImage = 'assets/images/module1/chapter1/round1/warrior1_idle.gif';
  double heroPosition = 0;
  double enemyPosition = 0;
  double resetEnemyPosition = 580;
  ...
  double initialEnemyPosition = 0.8; // Adjust as per screen width
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter1/round1/warrior1_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter1/round1/warrior1_idle.gif';
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    ...
    setState(() {
      enemyImage = 'assets/images/module1/chapter1/round1/warrior1_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter1/round1/warrior1_attck1.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter1/round1/warrior1_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    ...
    setState(() {
      enemyImage = 'assets/images/module1/chapter1/round1/warrior1_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter1/round1/warrior1_idle.gif';
