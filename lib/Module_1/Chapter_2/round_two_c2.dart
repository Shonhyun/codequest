...
import 'package:code_quest_pre/Module_1/shared.dart';
import 'package:flame_audio/flame_audio.dart';
import 'package:flutter/material.dart';
import 'package:code_quest_pre/Module_1/module_one.dart';
import 'package:code_quest_pre/Module_1/module_one_progress.dart'; // Ensure this file has the updateStarsForChapter method
import '../../../Widgets/game_ui.dart'; // Import the new file
import '../../Questions/questions.dart';
import '../../../Widgets/game_elements.dart';

class RoundTwoCh2 extends StatefulWidget {
  @override
  _RoundTwoCh2State createState() => _RoundTwoCh2State();
}

class _RoundTwoCh2State extends State<RoundTwoCh2> {
  String heroImage = 'assets/images/hero.gif';
  String enemyImage = 'assets/images/module1/chapter2/round2/warrior2_idle.gif';
  ...
  int difficultyLevel = 2; // 1 = Easy, 2 = Normal (default), 3 = Hard
  int score = 0;
  ...
  bool isPaused = false;
  bool isChapterTwoCompleted = ModuleOneProgress.isChapterCompleted(2);
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter2/round2/warrior2_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter2/round2/warrior2_idle.gif';
            });
          });
        }
      });
  ...
  void enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round2/warrior2_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter2/round2/warrior2_attck2.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter2/round2/warrior2_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round2/warrior2_dead.gif';
    });
    ...
    countdownTimer = Timer.periodic(Duration(seconds: 1), (timer) {
      if (!isPaused) {
        if (countdown > 0) {
          ...
          timer.cancel();
          enemyRunAndAttack(); // Trigger _enemyRunAndAttack when countdown reaches zero
        }
      }
    });
  }
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter2/round2/warrior2_idle.gif';
  ...
  void _navigateToModuleOne() {
    ...
    int currentRound =
        2; // Replace with the actual round number you're completing
    ModuleOneProgress.updateStarsForChapter(2, currentRound, stars);
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => ModuleOneMap(
            completedRoundChapter2:
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/GameSceneBG/GameSceneBG1.png'),
                fit: BoxFit.fill,
              ),
            ),
          ),
