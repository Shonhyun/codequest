...
class _RoundTwoCh2State extends State<RoundTwoCh2> {
  ...
  String enemyImage =
      'assets/images/module5/chapter2/round2/skeleton2_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module5/chapter2/round2/skeleton2_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    ...
    setState(() {
      enemyImage =
          'assets/images/module5/chapter2/round2/skeleton2_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter2/round2/skeleton2_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module5/chapter2/round2/skeleton2_idle.gif';
  ...
  void _navigateToModuleFive() {
    ...
    ModuleFiveProgress.updateStarsForChapter(2, currentRound, stars);
