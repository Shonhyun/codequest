...
class _RoundTwoCh3State extends State<RoundTwoCh3> {
  ...
  String enemyImage = 'assets/images/module3/chapter3/round2/plant_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module3/chapter3/round2/plant_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module3/chapter3/round2/plant_walk_LR.gif';
      enemyPosition = screenWidth * attackEnemyPosition;
    });

    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage = 'assets/images/module3/chapter3/round2/plant_attck1.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module3/chapter3/round2/plant_walk_RL.gif';
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              enemyImage =
                  'assets/images/module3/chapter3/round2/plant_idle.gif';
              heroImage = 'assets/images/hero.gif';
            });
          });
        }
  ...
  void _handleHeroDeath() {
    ...
    Future.delayed(Duration(milliseconds: 900), () {
      setState(() {
        isHeroDead = true;
        enemyImage = 'assets/images/module3/chapter3/round2/plant_walk_RL.gif';
      });

      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage = 'assets/images/module3/chapter3/round2/plant_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module3/chapter3/round2/plant_dead.gif';
    });
