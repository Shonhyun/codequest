...
class _RoundTwoState extends State<RoundTwo> {
  ...
  String enemyImage =
      'assets/images/module5/chapter1/round2/skeleton2_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module5/chapter1/round2/skeleton2_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    ...
    setState(() {
      enemyImage =
          'assets/images/module5/chapter1/round2/skeleton2_walk_LR.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module5/chapter1/round2/skeleton2_attack.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module5/chapter1/round2/skeleton2_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter1/round2/skeleton2_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module5/chapter1/round2/skeleton2_idle.gif';
  ...
  void _navigateToModuleFive() {
    ...
    ModuleFiveProgress.updateStarsForChapter(1, currentRound, stars);
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/GameSceneBG/GameSceneBG5.png'),
                fit: BoxFit.fill,
              ),
            ),
          ),
