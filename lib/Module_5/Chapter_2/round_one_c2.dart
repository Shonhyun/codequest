...
class _RoundOneCh2State extends State<RoundOneCh2> {
  ...
  String enemyImage =
      'assets/images/module5/chapter1/round1/skeleton2_idle.gif';
  ...
  bool isPaused = false;
  bool isChapterTwoCompleted = ModuleFiveProgress.isChapterCompleted(1);
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module5/chapter1/round1/skeleton2_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    ...
    setState(() {
      enemyImage =
          'assets/images/module5/chapter1/round1/skeleton2_walk_LR.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module5/chapter1/round1/skeleton2_attack.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module5/chapter1/round1/skeleton2_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter1/round1/skeleton2_dead.gif';
    });
    ...
    Future.delayed(Duration(milliseconds: 750), () {
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage =
              'assets/images/module5/chapter2/round1/skeleton2_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module5/chapter2/round1/skeleton2_idle.gif';
