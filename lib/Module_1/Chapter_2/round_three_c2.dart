...
class RoundThreeCh2 extends StatefulWidget {
  @override
  _RoundThreeCh2State createState() => _RoundThreeCh2State();
}

class _RoundThreeCh2State extends State<RoundThreeCh2> {
  String heroImage = 'assets/images/hero.gif';
  String enemyImage = 'assets/images/module1/chapter2/round3/peasant_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter2/round3/peasant_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter2/round3/peasant_idle.gif';
              print("Hero is back to default");
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round3/peasant_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter2/round3/peasant_attack2.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('knife.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter2/round3/peasant_walk_RL.gif';
  ...
  void _handleHeroDeath() {
    ...
    Future.delayed(Duration(milliseconds: 900), () {
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        setState(() {
          heroImage = 'assets/images/hero.gif';
          enemyImage = 'assets/images/module1/chapter2/round3/peasant_idle.gif';
          heroPosition = screenWidth * initialHeroPosition;
          enemyPosition = screenWidth * initialEnemyPosition;
        });
      });
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round3/peasant_dead.gif';
    });
  ...
  void _navigateToModuleOne() {
    ...
    // Example: Updating stars for Chapter 2, Round 1
    // Update this line based on the actual current round you want to update
    int currentRound =
        3; // Replace with the actual round number you're completing
