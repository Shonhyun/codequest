...
class RoundThreeCh3 extends StatefulWidget {
  @override
  _RoundThreeCh3State createState() => _RoundThreeCh3State();
}

class _RoundThreeCh3State extends State<RoundThreeCh3> {
  String heroImage = 'assets/images/hero.gif';
  String enemyImage = 'assets/images/module1/chapter3/round3/kunoichi_idle.gif';
  ...
  List<Question> answeredQuestions = [
    ...
    //   chapter: 3,
    //   module: 1,
    //   question: 'What is the name of the Japanese martial art that emphasizes throwing, grappling, and submission holds?',
    //   answer: 'Judo',
    // ),
  ];
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter3/round3/kunoichi_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter3/round3/kunoichi_idle.gif';
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter3/round3/kunoichi_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter3/round3/kunoichi_attack2.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('whip.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter3/round3/kunoichi_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter3/round3/kunoichi_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter3/round3/kunoichi_idle.gif';
  ...
  void _navigateToModuleOne() {
    ...
    // Example: Updating stars for Chapter 2, Round 3
    int currentRound = 3; // The current round number
    ModuleOneProgress.updateStarsForChapter(3, currentRound, stars);
    ...
    // Navigate back to the ModuleOneMap
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) =>
            ModuleOneMap(completedRoundChapter3: currentRound),
      ),
    );
  }
