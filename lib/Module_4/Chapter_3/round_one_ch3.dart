...
class _RoundOneCh3State extends State<RoundOneCh3> {
  ...
  String enemyImage =
      'assets/images/module4/chapter3/round1/skeleton1_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module4/chapter3/round1/skeleton1_hurt.gif';
        enemyLives--;
  ...
  void _enemyRunAndAttack() {
    ...
    setState(() {
      enemyImage =
          'assets/images/module4/chapter3/round1/skeleton1_walk_LR.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module4/chapter3/round1/skeleton1_attack.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module4/chapter3/round1/skeleton1_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module4/chapter3/round1/skeleton1_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module4/chapter3/round1/skeleton1_idle.gif';
