...
class RoundTwoCh3 extends StatefulWidget {
  @override
  _RoundTwoCh3State createState() => _RoundTwoCh3State();
}

class _RoundTwoCh3State extends State<RoundTwoCh3> {
  String heroImage = 'assets/images/hero.gif';
  String enemyImage = 'assets/images/module1/chapter3/round2/warrior3_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter3/round2/warrior3_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter3/round2/warrior3_idle.gif';
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter3/round2/warrior3_walk_LR.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter3/round2/warrior3_attck2.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter3/round2/warrior3_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter3/round2/warrior3_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter3/round2/warrior3_idle.gif';
