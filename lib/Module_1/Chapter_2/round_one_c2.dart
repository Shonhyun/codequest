...
class RoundOneCh2 extends StatefulWidget {
  @override
  _RoundOneCh2State createState() => _RoundOneCh2State();
}

class _RoundOneCh2State extends State<RoundOneCh2> {
  String heroImage = 'assets/images/hero.gif';
  String enemyImage = 'assets/images/module1/chapter2/round1/warrior2_idle.gif';
  ...
  bool isPaused = false;
  bool isChapterTwoCompleted = ModuleOneProgress.isChapterCompleted(1);
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module1/chapter2/round1/warrior2_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module1/chapter2/round1/warrior2_idle.gif';
            });
          });
        }
      });
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round1/warrior2_run.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module1/chapter2/round1/warrior2_attck2.gif';
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module1/chapter2/round1/warrior2_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module1/chapter2/round1/warrior2_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module1/chapter2/round1/warrior2_idle.gif';
  ...
  void _navigateToModuleOne() {
    ...
    int currentRound =
        1; // Replace with the actual round number you're completing
