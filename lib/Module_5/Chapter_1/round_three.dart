...
class _RoundThreeState extends State<RoundThree> {
  ...
  String enemyImage = 'assets/images/module5/chapter1/round3/wanderer_idle.gif';
  ...
  void _runAndAttack() {
    ...
    Future.delayed(Duration(milliseconds: 1600), () {
      setState(() {
        ...
        enemyImage = 'assets/images/module5/chapter1/round3/wanderer_hurt.gif';
        enemyLives--;
        ...
        if (enemyLives > 0) {
          ...
          Future.delayed(Duration(milliseconds: 1600), () {
            setState(() {
              ...
              enemyImage =
                  'assets/images/module5/chapter1/round3/wanderer_idle.gif';
  ...
  void _enemyRunAndAttack() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter1/round3/wanderer_walk_LR.gif';
    ...
    Future.delayed(Duration(milliseconds: 1400), () {
      setState(() {
        enemyImage =
            'assets/images/module5/chapter1/round3/wanderer_attack1.gif';
        heroImage = 'assets/images/hero_hurt.gif';
        heroLives--;
        FlameAudio.play('wanderer.mp3', volume: soundEffectsVolume);
      ...
      Future.delayed(Duration(milliseconds: 800), () {
        if (heroLives > 0) {
          setState(() {
            enemyImage =
                'assets/images/module5/chapter1/round3/wanderer_walk_RL.gif';
  ...
  void _handleEnemyDeath() {
    final screenWidth = MediaQuery.of(context).size.width;
    setState(() {
      enemyImage = 'assets/images/module5/chapter1/round3/wanderer_dead.gif';
    });
  ...
  void _resetGame() {
    ...
    setState(() {
      ...
      isEnemyDead = false;
      heroImage = 'assets/images/hero.gif';
      enemyImage = 'assets/images/module5/chapter1/round3/wanderer_idle.gif';
  ...
  void _navigateToModuleFive() {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
        builder: (context) =>
            ModuleFiveMap(completedRoundChapter1: currentRound),
      ),
    );
  }
